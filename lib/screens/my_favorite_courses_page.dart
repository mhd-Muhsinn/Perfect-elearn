...
class MyFavoriteCoursesPage extends StatelessWidget {
  const MyFavoriteCoursesPage({super.key});

  @override
  Widget build(BuildContext ctx) {
    ctx.read<MyLibraryCubit>().loadFavoriteCourses();
    final responsive = ResponsiveConfig(ctx);
    return Scaffold(
        backgroundColor: PColors.backgrndPrimary,
        appBar: CustomAppBar(title: 'Favorite Courses'),
        ...
        return Padding(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              final course = state.favoriteCourses[index];
